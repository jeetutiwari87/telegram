   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="fa fa-user"></span> {{ auth()->user()->first_name }}<b class="caret"></b></a>
                ...
                <ul class="nav navbar-nav side-nav">
                    @if(session('statut') == 'admin')
						...
						<li {!! classActiveSegment(1, 'plan') !!}>
                            <a href="#" data-toggle="collapse" data-target="#planmenu"><span class="fa fa-fw fa-user"></span> {{ trans('back/admin.plans') }} <span class="fa fa-fw fa-caret-down"></span></a>
                            <ul id="planmenu" class="collapse">
                                <li><a href="{!! url('plan') !!}">{{ trans('back/admin.see-all') }}</a></li>
                                <li><a href="{!! url('plan/create') !!}">{{ trans('back/admin.add') }}</a></li>
                            </ul>
                        </li>
